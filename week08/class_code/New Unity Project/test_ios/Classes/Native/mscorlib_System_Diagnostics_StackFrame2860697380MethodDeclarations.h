...
extern "C"  bool StackFrame_get_frame_info_m2232383397 (Object_t * __this /* static, unused */, int32_t ___skip, bool ___needFileInfo, MethodBase_t3461000640 ** ___method, int32_t* ___iloffset, int32_t* ___native_offset, String_t** ___file, int32_t* ___line, int32_t* ___column, const MethodInfo* method) IL2CPP_METHOD_ATTR;
